package expo.modules.provideoeditor.src.shared.media
 ...
 *
 * Bytes that arrive over the JS boundary are already in the managed heap and
...
sealed class EncodedImage {
    ...
    companion object {
        /**
         * Reads an image source out of a render-config map, preferring the
         * on-disk path over inline bytes when both are present.
         *
