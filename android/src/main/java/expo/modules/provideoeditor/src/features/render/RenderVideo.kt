package expo.modules.provideoeditor.src.features.render
...
import expo.modules.provideoeditor.src.features.render.utils.mapFormatToMimeType
import expo.modules.provideoeditor.src.features.render.helpers.BitrateCapPolicy
import expo.modules.provideoeditor.src.features.render.helpers.EncoderFailureClassifier
import expo.modules.provideoeditor.src.features.render.helpers.ResilientVideoEncoderFactory
import expo.modules.provideoeditor.src.features.render.helpers.applyComposition
import expo.modules.provideoeditor.src.features.render.helpers.VolumeControlAudioMixerFactory
import expo.modules.provideoeditor.src.features.render.helpers.ConfigurableInAppMp4Muxer
import expo.modules.provideoeditor.src.features.render.helpers.VideoTranscoder
import expo.modules.provideoeditor.src.features.render.helpers.VideoReverser
import expo.modules.provideoeditor.src.features.render.helpers.ClipTransitionGeometry
import expo.modules.provideoeditor.src.features.render.helpers.ClipTransitionRenderer
import expo.modules.provideoeditor.src.features.render.helpers.MediaInfoExtractor
import expo.modules.provideoeditor.src.features.render.models.ChromaKeyConfig
import expo.modules.provideoeditor.src.features.render.models.CodecResourceExhaustedException
...
import expo.modules.provideoeditor.src.features.render.models.VideoClip
import expo.modules.provideoeditor.src.features.render.models.VideoEncoderConfigurationException
import expo.modules.provideoeditor.src.shared.concurrency.ExportGate
import expo.modules.provideoeditor.src.shared.concurrency.ExportGateGuard
...
class RenderVideo(private val context: Context) {
    ...
    private fun preReverseClips(
        ...
        reversedClipIndices.forEachIndexed { progressIdx, clipIdx ->
            ...
            val endUs = clip.endUs
                ?: expo.modules.provideoeditor.src.features.render.helpers
     ...
     *
     * Both are typed so this module can show a proper error state instead
