...
import expo.modules.provideoeditor.src.features.render.helpers.applyChromaKey
import expo.modules.provideoeditor.src.features.render.helpers.applyScale
...
import expo.modules.provideoeditor.src.features.render.models.LayerAnimationConfig
import expo.modules.provideoeditor.src.features.render.models.VideoClip
import expo.modules.provideoeditor.src.features.render.utils.getRotatedVideoDimensions
...
class VideoSequenceBuilder(
    ...
    private fun dipColorFor(transition: expo.modules.provideoeditor.src.features
